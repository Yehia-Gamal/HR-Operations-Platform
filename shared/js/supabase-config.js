...
window.HR_SUPABASE_CONFIG = Object.freeze({
  ...
  deployment: {
    ...
    packageVersion: "v31-live-location-alert-fix-084",
  },
  // Used by service workers to invalidate old caches
  cacheVersion: "v31-live-location-alert-fix-084",
});

window.__HR_SUPABASE_CONFIG_LOADED__ = true;
window.__HR_SUPABASE_CONFIG_VERSION__ = "v31-live-location-alert-fix-084";
