import { seedDatabase } from "./database.js?v=v31-live-location-alert-fix-081";
import { supabaseEndpoints, shouldUseSupabase, supabaseModeIsStrict } from "./supabase-api.js?v=v31-live-location-alert-fix-081";
