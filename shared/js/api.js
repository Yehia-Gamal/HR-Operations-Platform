import { seedDatabase } from "./database.js?v=v31-production-deploy-ready-keep-dev-files";
import { supabaseEndpoints, shouldUseSupabase, supabaseModeIsStrict } from "./supabase-api.js?v=v31-production-deploy-ready-keep-dev-files";
