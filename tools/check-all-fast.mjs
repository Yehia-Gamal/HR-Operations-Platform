...
assert(sw.includes('hr-attendance-management-suite-20260502-01') && reg.includes('hr-attendance-management-suite-20260502-01'), 'Service worker cache must be management-suite version.');
