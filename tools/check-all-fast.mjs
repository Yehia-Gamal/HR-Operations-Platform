...
assert(read('package.json').includes('v31-live-location-alert-fix-083'), 'Package version must be v31-live-location-alert-fix-083.');
...
assert(sw.includes('v31-live-location-alert-fix-083') && reg.includes('v31-live-location-alert-fix-083'), 'Service worker cache must be v29 version.');
