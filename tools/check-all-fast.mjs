...
assert(read('package.json').includes('v31-live-location-alert-fix-082'), 'Package version must be v31-live-location-alert-fix-082.');
...
assert(sw.includes('v31-live-location-alert-fix-082') && reg.includes('v31-live-location-alert-fix-082'), 'Service worker cache must be v29 version.');
