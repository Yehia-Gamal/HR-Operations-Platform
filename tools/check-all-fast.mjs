...
assert(read('package.json').includes('v31-live-location-alert-fix-084'), 'Package version must be v31-live-location-alert-fix-084.');
...
assert(sw.includes('v31-live-location-alert-fix-084') && reg.includes('v31-live-location-alert-fix-084'), 'Service worker cache must be v29 version.');
