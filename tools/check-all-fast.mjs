...
assert(read('package.json').includes('v31-live-location-alert-fix-081'), 'Package version must be v31-live-location-alert-fix-081.');
...
assert(sw.includes('v31-live-location-alert-fix-081') && reg.includes('v31-live-location-alert-fix-081'), 'Service worker cache must be v29 version.');
